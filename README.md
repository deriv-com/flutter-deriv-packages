...
deriv_ui:
  git:
    ...
    ref: deriv_ui-v0.0.6+5 #your prefered version
```
...
| [deriv_auth](./packages/deriv_auth)                                       | A Dart package that provides Authentication logic for Deriv applications.                                              | [v6.2.0 ](./packages/deriv_auth/CHANGELOG.md)                     |
...
| [deriv_language_selector](./packages/deriv_language_selector)             | A package to handle language change of the app.                                                                        | [v0.0.1](./packages/deriv_language_selector/CHANGELOG.md)         |
...
| [deriv_ui](./packages/deriv_ui)                                           | A package that contains the UI components used by Deriv products.                                                      | [v0.0.6+5](./packages/deriv_ui/CHANGELOG.md)                      |
