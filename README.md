...
Each package has been released as git tag with convention as **packageName-vVersionNumber**`(Example: deriv_auth-v1.2.2)`. To use the package, add the following to your pubspec.yaml file:
...
deriv_ui:
  git:
    ...
    ref: deriv_ui-v0.0.3 #your prefered version
```
...
| ------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| [analytics](./packages/analytics)                                         | Used to collect and send analytical information to 'Firebase' and 'Segment'.                                           | [v1.1.0](./packages/analytics/CHANGELOG.md)                       |
| [deriv_auth](./packages/deriv_auth)                                       | A Dart package that provides Authentication logic for Deriv applications.                                              | [v1.2.2 ](./packages/deriv_auth/CHANGELOG.md)                     |
| [deriv_auth_ui](./packages/deriv_auth_ui)                                 | A Dart package that provides Authentication UI for Deriv applications.                                                 | [v0.0.3](./packages/deriv_auth_ui/CHANGELOG.md)                 |
| [deriv_banner](./packages/deriv_banner)                                   | A widget to show banner in apps.                                                                                       | [v0.0.2](./packages/deriv_banner/CHANGELOG.md)                    |
...
| [deriv_date_range_picker](./packages/deriv_date_range_picker)             | Provides a widget that allows users to select a date range either by calendar mode or input mode.                      | [v0.0.1+3](./packages/deriv_date_range_picker/CHANGELOG.md)       |
...
| [deriv_env](./packages/deriv_env)                                         | A package to load and store environment variables.                                                                     | [v0.0.1+3](./packages/deriv_env/CHANGELOG.md)                     |
| [deriv_expandable_bottom_sheet](./packages/deriv_expandable_bottom_sheet) | A widget that helps to display an expandable bottom sheet.                                                             | [v0.0.1+3](./packages/deriv_expandable_bottom_sheet/CHANGELOG.md) |
...
| [deriv_numpad](./packages/deriv_numpad)                                   | Number Pad Widget for number input.                                                                                    | [v1.0.3](./packages/deriv_numpad/CHANGELOG.md)                    |
...
| [deriv_theme](./packages/deriv_theme)                                     | A package that contains the theme used by Deriv products.                                                              | [v2.3.0](./packages/deriv_theme/CHANGELOG.md)                     |
| [deriv_ui](./packages/deriv_ui)                                           | A package that contains the UI components used by Deriv products.                                                      | [v0.0.3](./packages/deriv_ui/CHANGELOG.md)                        |
...
| [deriv_feature_flag](./packages/deriv_feature_flag)                       | A package to provide feature flag functionality for apps.                                                              | [v0.0.1+1](./packages/deriv_feature_flag/CHANGELOG.md)              |
