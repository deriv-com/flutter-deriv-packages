...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.deriv.flutter_deriv_api.FlutterDerivApiPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_deriv_api, com.deriv.flutter_deriv_api.FlutterDerivApiPlugin", e);
    }
    try {
