...
class DarkThemeColors {
  @Deprecated('Use `prominent` instead')
  ...
  @Deprecated('Use `lessProminent` instead')
  ...
  static const Color secondary = Color(0xFF151717);
...
class LightThemeColors {
  ...
  static const Color secondary = Color(0xFFF2F3F4);
