...
void main() {
  group('Enums', () {
    test('TrackingConsentExtension: consent should return the corresponding datadog.TrackingConsent value', () {
      expect(TrackingConsent.granted.consent, datadog.TrackingConsent.granted);
      expect(TrackingConsent.notGranted.consent, datadog.TrackingConsent.notGranted);
      expect(TrackingConsent.pending.consent, datadog.TrackingConsent.pending);
    });

    test('DatadogSiteExtension: site should return the corresponding datadog.DatadogSite value', () {
