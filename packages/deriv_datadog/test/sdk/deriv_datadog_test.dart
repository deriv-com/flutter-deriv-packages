...
void main() {
  ...
  group('DerivDatadog', () {
    ...
    test('navigationObserver', () {
      final datadog.DatadogNavigationObserver navigationObserver = mockDerivDatadog.navigationObserver;
    ...
    test('onTapEvent', () {
      ...
      const Map<String, Object?> attributes = <String, Object?>{'attribute': 'value'};
