...
class DerivAuthLocalizationsVi extends DerivAuthLocalizations {
  ...
  String get informEnterTwoFactorAuthCode =>
      'Nhập mã gồm 6 chữ số từ ứng dụng xác thực trên điện thoại của bạn.';
  ...
  String get informRedirectLogin =>
      'Bạn sẽ cần đăng nhập bằng mật khẩu mới của mình. Chờ đã, chúng tôi đang chuyển hướng bạn.';
  ...
  String get informInvalidPasswordFormat =>
      'Vui lòng nhập một định dạng mật khẩu hợp lệ';
  ...
  String get informResetPassByEmail =>
      'Chúng tôi sẽ gửi email hướng dẫn đổi mật khẩu cho bạn.';
  ...
  String get warnCountryNotAvailable =>
      'Rất tiếc, Deriv không khả dụng ở quốc gia của bạn.';
  ...
  String get labelEmailIssueHeader =>
      'Nếu sau vài phút bạn không nhận được email từ chúng tôi, một vài điều sau có thể đã xảy ra:';

  @override
  String get labelEmailIssueSpam =>
      'Email có thể đã bị chuyển vào hòm thư spam (Đôi lúc dữ liệu bị lạc mất trong đó).';

  @override
  String get labelEmailIssueWrongEmail =>
      'Bạn đã vô tình đưa cho chúng tôi một tài khoản email khác (Thường là một tài khoản cho công việc hoặc cá nhân thay vì tài khoản mà bạn định sử dụng).';

  @override
  String get labelEmailIssueTypo =>
      'Địa chỉ email bạn nhập bị nhầm hoặc có lỗi chính tả (hay xảy ra với chúng tôi).';

  @override
  String get labelEmailIssueFirewall =>
      'Chúng tôi không thể chuyển email đến địa chỉ này (Thường là do tường lửa hoặc bộ lọc).';
  ...
  String get labelKeepPassword =>
      'Bảo vệ tài khoản của bạn an toàn với mật khẩu';
  ...
  String get infoReferralInfoDescription =>
      'Mã chữ và số được cung cấp bởi một đơn vị liên kết Deriv, chỉ áp dụng cho đăng ký qua email.';
  ...
  String get warnPasswordContainsSymbol =>
      'Sử dụng các ký hiệu cho mật khẩu mạnh.';
  ...
  String get informFailedAuthentication =>
      'Email hoặc mật khẩu của bạn có thể không chính xác. Bạn đã đăng ký với một tài khoản xã hội chưa? Kiểm tra và thử lại.';
  ...
  String get labelCountryConsentBrazil =>
      'Tôi xác nhận rằng yêu cầu mở tài khoản của tôi với Deriv để giao dịch các sản phẩm OTC được phát hành và cung cấp độc quyền bên ngoài Brazil là do tôi thực hiện. Tôi hoàn toàn hiểu rằng Deriv không bị quản lý bởi CVM và thông qua Deriv, tôi dự định thiết lập quan hệ với một công ty nước ngoài.';
  ...
  String get informSwitchAccountError =>
      'Chuyển đổi lỗi tài khoản. Vui lòng thử lại sau.';
