...
class DerivPasskeysLocalizationsDe extends DerivPasskeysLocalizations {
  ...
  String get enhanceSecurity =>
      'Verbesserte Sicherheit ist nur einen Fingertipp entfernt.';
  ...
  String get whatArePasskeysDescriptionPoint2 =>
      'Entsperren Sie Ihr Konto wie Ihr Telefon - mit biometrischen Daten, Gesichtsscan oder PIN.';
  ...
  String get whyPasskeysDescription2 =>
      'Schützt vor unbefugtem Zugriff und Phishing.';
  ...
  String get howToCreatePasskeyDescription1 =>
      'Gehen Sie zu \'Kontoeinstellungen\' auf Deriv.';

  @override
  String get howToCreatePasskeyDescription2 =>
      'Sie können einen Passkey pro Gerät erstellen.';
  ...
  String get p2pHowToCreatePasskeyDescription1 =>
      'Gehen Sie in Ihrer Deriv P2P-App zu „Profil“.';

  @override
  String get p2pHowToCreatePasskeyDescription2 =>
      'Tippen Sie auf „Passkeys“, um Ihren Passkey zu erstellen.';
  ...
  String get whereArePasskeysSavedDescriptionAndroid =>
      'Android: Google Passwort-Manager.';

  @override
  String get whereArePasskeysSavedDescriptionIOS =>
      'iOS: iCloud-Schlüsselbund.';

  @override
  String get whatHappensIfEmailChanged =>
      'Was passiert, wenn die E-Mail-Adresse meines Deriv-Kontos geändert wird?';

  @override
  String get whatHappensIfEmailChangedDescription1 =>
      'Kein Problem! Ihr Passkey funktioniert noch.';

  @override
  String get whatHappensIfEmailChangedDescription2 =>
      'Melden Sie sich bei Deriv mit Ihrem bestehenden Passkey an.';
  ...
  String get enableScreenLock =>
      'Aktiviere die Bildschirmsperre auf deinem Gerät.';

  @override
  String get signInGoogleOrIcloud =>
      'Melde dich bei deinem Google- oder iCloud-Konto an.';
  ...
  String get noPasskeyFoundDescription =>
      'Bitte erstellen Sie einen Passkey, um diese Funktion zu nutzen.';
  ...
  String get useYourBiometrics =>
      'Erhöhte Sicherheit durch Biometrie oder Bildschirmsperre';
  ...
  String get unableToSetupPasskeyDescription =>
      'Beim Einrichten Ihres Passkey ist ein Problem aufgetreten. Der Vorgang wurde möglicherweise unterbrochen oder die Sitzung wurde unterbrochen. Bitte versuchen Sie es erneut.';
  ...
  String get unable_to_process_your_request_description =>
      'Wir haben ein vorübergehendes Problem bei der Bearbeitung Ihrer Anfrage. Bitte versuchen Sie es später erneut.';
}
