...
class DerivPasskeysLocalizationsSi extends DerivPasskeysLocalizations {
  DerivPasskeysLocalizationsSi([String locale = 'si']) : super(locale);

  @override
  String get passkeyCreatedSuccessTitle => 'සාර්ථකයි!';
  ...
  @override
  String get continueButtonText => 'ඉදිරියට යන්න';

  @override
  String get unexpectedError => 'අනපේක්ෂිත දෝෂයක් ඇති විය!';

  @override
  String get unexpectedErrorDescription => 'කරුණාකර පසුව උත්සාහ කරන්න.';

  @override
  String get ok => 'Ok';

  @override
  String get experienceSaferLogins => 'ආරක්ෂිත පිවිසුම් අත්විඳින්න';

  @override
  String get enhanceSecurity => 'වැඩි දියුණු කළ ආරක්ෂාව එක ටැප් එකක් දුරින්.';
  ...
  @override
  String get whereArePasskeysSavedDescriptionIOS => 'iOS: iCloud යතුරු දාමය.';
  ...
  @override
  String get signInGoogleOrIcloud => 'ඔබේ Google හෝ iCloud ගිණුමට පිවිසෙන්න.';
  ...
  @override
  String get useYourBiometrics => 'ජෛවමිතික හෝ තිර අගුල සමඟ වැඩි දියුණු කළ ආරක්ෂාව';
  ...
  @override
  String get storedOn => 'ගබඩා කර ඇත';

  @override
  String get lastUsed => 'අවසන් වරට භාවිත කළේ';
  ...
  @override
  String get unable_to_process_your_request => 'ඔබගේ ඉල්ලීම සැකසීමට නොහැකි විය';

  @override
  String get unable_to_process_your_request_description => 'ඔබගේ ඉල්ලීම සැකසීමේදී අපට තාවකාලික ගැටළුවක් අත්විඳිනවා. කරුණාකර පසුව නැවත උත්සාහ කරන්න.';
}
