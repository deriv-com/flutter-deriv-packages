...
class DerivLiveChatPlugin : FlutterPlugin, MethodCallHandler,
    ...
    companion object {
        const val liveChatMethodChannel = "deriv_live_chat"
        const val liveChatEventChannel = "deriv_live_chat_event_listener"
    }

    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        channel = MethodChannel(flutterPluginBinding.binaryMessenger, liveChatMethodChannel)
        channel.setMethodCallHandler(this)

        EventChannel(flutterPluginBinding.binaryMessenger, liveChatEventChannel)
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) =
            if (call.method.equals("derivLiveChatView")) {
                ...
                if (chatWindowView == null) {
                    ...
                    chatWindowView?.setBackgroundColor(Color.BLACK)
