...
class _GroupedListViewState<E, G extends Comparable<Object>>
          ...
          return Column(
            children: <Widget>[
              Builder(builder: (BuildContext context) {
                ...
                return widget.itemBuilder(widget.items![actualIndex]!);
              }),
  ...
  void _sortList(List<E?>? list) {
    ...
    list.sort((E? firstItem, E? secondItem) => widget.sortPredicate == null
        ? defaultCompareFunction(firstItem!, secondItem!) * isAscending
        : widget.sortPredicate!(firstItem!, secondItem!) * isAscending);
  }
