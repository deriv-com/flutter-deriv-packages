/// Indicates the number of inputs in the NumberPad widget, between one or two
/// inputs.
...
/// Indicates which input field should be focused when [NumberPadWidgetType] is
/// double input.
...
enum NumberPadCloseType {
  ...
  /// when the user clicked anywhere outside the widget to dismiss the NumberPad
  /// widget
  clickOutsideView,
}
